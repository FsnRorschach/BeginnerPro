programa
{
	...
	funcao inicio()
	{
		escreva("Verificar o nome do mês \n")
		escreva("Digite o numero do mês que deseja consultar o nome : ")
		leia(mes)
		...
		escolha(mes){
			...
			pare
			caso contrario: escreva("Digite um numero entre 1 e 12 correspondente aos meses do ano")
			pare
		}
	}
}
